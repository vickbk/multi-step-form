...
import type { PlanInputType, StrictBilling } from "../types";

export const BILLING: StrictBilling[] = ["monthly", "yearly"];

export const PLANS_INPUTS: Record<StrictBilling, PlanInputType[]> = {
  yearly: [
    {
      name: "arcade",
      price: 90,
